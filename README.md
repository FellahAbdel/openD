...
2. List the item into mapOfListings (for sale):
...
```
dfx canister call rno2w-sqaaa-aaaaa-aaacq-cai (<= nftPrinipal) transferOwnership '(principal "qsgjb-riaaa-aaaaa-aaaga-cai (<= openDPrincipal)", true)'
```
